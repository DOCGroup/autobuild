...
test_error = re.compile(r'Error|ERROR|fatal|EXCEPTION|ACE_ASSERT|Assertion|Mismatched free|are definitely lost in loss record|: parse error|Invalid write of size|Invalid read of size|pure virtual ')
