...
#The testmatrix database for saving the test results locally.
DATABASE_NAME=""
...
PROTECTION_FILE=$DB_FILE_DIR/GETTING_LOCAL_TEST_DB_FILES.LOCK
...
CURRENT_DB_FILES_SCRIPT=RecentTestDBFiles.sh
# Script to add the files to the database
ADD_FILES_TO_DB_SCRIPT=SaveTestsToDB.sh
