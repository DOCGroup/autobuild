...
/usr/bin/perl buildmatrix/buildmatrix.pl $HOME/autobuild/configs/scoreboard/ace.xml /project/taotmp/scoreboard/html > /project/taotmp/scoreboard/buildmatrix/output.html 2> /tmp/build.out

/usr/bin/perl buildmatrix/buildmatrix.pl $HOME/autobuild/configs/scoreboard/tao.xml /project/taotmp/scoreboard/html > /project/taotmp/scoreboard/buildmatrix/tao.html 2> /tmp/build.out
