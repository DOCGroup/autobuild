...
/usr/bin/perl ./scoreboard.pl -x -v -d /export/web/www/scoreboard -f $HOME/autobuild/configs/scoreboard/ace.xml -o ace.html -r ace.rss 2>&1 &
...
/usr/bin/perl ./scoreboard.pl -x -d /export/web/www/scoreboard -f $HOME/autobuild/configs/scoreboard/tao.xml -o tao.html -r tao.rss 2>&1  &
...
/usr/bin/perl ./scoreboard.pl -x -d /export/web/www/scoreboard -z 2>&1 &
