...
/usr/bin/perl ./scoreboard.pl -n -v -d /export/web/www/scoreboard -f $HOME/autobuild/configs/scoreboard/ace.xml -o ace.html -r ace.rss 2>&1 &
...
/usr/bin/perl ./scoreboard.pl -n -d /export/web/www/scoreboard -f $HOME/autobuild/configs/scoreboard/tao.xml -o tao.html -r tao.rss 2>&1  &
...
/usr/bin/perl ./scoreboard.pl -n -d /export/web/www/scoreboard -f $HOME/autobuild/configs/scoreboard/ciao.xml -o ciao.html -r ciao.rss 2>&1  &
...
/usr/bin/perl ./scoreboard.pl -n -d /export/web/www/scoreboard -f $HOME/autobuild/configs/scoreboard/misc.xml -o misc.html 2>&1 &
...
/usr/bin/perl ./scoreboard.pl -n -d /export/web/www/scoreboard -z 2>&1 &
