...
exec /usr/bin/perl ./scoreboard.pl -v -d /export/project/workarea01/Scoreboard/html -f $HOME/autobuild/configs/scoreboard/ace.xml -o ace.html  2>&1 &
exec /usr/bin/perl ./scoreboard.pl -d /export/project/workarea01/Scoreboard/html -f $HOME/autobuild/configs/scoreboard/ace_future.xml -o ace_future.html 2>&1 &
