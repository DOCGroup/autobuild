...
exec /usr/bin/perl ./scoreboard.pl -v -d /export/project/workarea01/Scoreboard/html -f $HOME/autobuild/configs/scoreboard/ace.xml -o /export/project/workarea01/Scoreboard/html/ace.html  2>&1 &
