...
/bin/nohup /home/tao/doc_autobuild/autobuild/configs/autobuild/prism/LynxOS42_PPC_GCC322_Standard_Tests.sh > /home/tao/rad1/log/LynxOS42_PPC_GCC322_Standard_Tests.log 2>&1 < /dev/null &
