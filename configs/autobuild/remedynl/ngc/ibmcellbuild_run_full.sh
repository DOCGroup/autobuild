...
sh $HOME/ACE/autobuild/configs/autobuild/remedynl/ngc/ibmcellbuild_full_host.sh && $HOME/ACE/autobuild/configs/autobuild/remedynl/ngc/ibmcellbuild_opendds.sh
